 ...
 */
@WebServlet("/review/gradeSort")
public class ReviewGradeSortServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReviewGradeSortServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String grade = request.getParameter("REVIEW_GRADE");
		...
		// 로그인 유저의 참여했던 챌린지 조회해야 함(셀렉-옵션 칸 안에 넣음)
				...
				ArrayList<Review> sortByGradeList = rs.selectSortByGradeList(pi);
				
				request.setAttribute("pi", pi);
				request.setAttribute("sortByGradeList", sortByGradeList);
